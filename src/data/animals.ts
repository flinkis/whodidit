...
export const ANIMALS: Record<number, Animal> = {
    ...
    5: { id: 5, name: "Bear", height: 184, diet: "omnivore", image: "/assets/bear.png", color: "#795548" },
    6: { id: 6, name: "Horse", height: 200, diet: "herbivore", image: "/assets/horse.png", color: "#FF9800" },
    7: { id: 7, name: "Dog", height: 173, diet: "omnivore", image: "/assets/dog.png", color: "#FFC107" }
};
